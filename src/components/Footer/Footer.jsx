      ...
      <footer className="bg-[#001931]">
        <div className="max-w-7xl mx-auto grid grid-cols-12 gap-20 text-neutral-content pt-20 pb-10 border-b-1 border-b-cyan-950">
          <div className="col-span-6">
            <h2 className="text-4xl font-light leading-10 mb-8">
              Discover Every App You Need, All in One Place.
            </h2>
            <Link to="/" className="flex justify-start items-center pb-16">
              <img
                className="w-[50px]"
                src={Logo}
                alt="AppNexus.IO"
          ...
          <div className="col-span-3 flex flex-col justify-between">
            ...
            <div>
              ...
              <ul className="flex gap-5">
                <li className="border-1 border-[#975EEE] p-3 rounded-4xl text-lg">
                  <a href="#">
                    <FaFacebookF />
                  </a>
                </li>
        ...
        {/* Lower Part */}
        <div className="text-white font-light opacity-50 max-w-7xl mx-auto flex justify-between pt-5 pb-20">
